package com.wslight.nvstream.http;
...
//import com.wslight.BuildConfig;
import com.wslight.LimeLog;
import com.wslight.nvstream.ConnectionContext;
...
public class NvHTTP {
    ...
    private static boolean verbose = false;//BuildConfig.DEBUG;
